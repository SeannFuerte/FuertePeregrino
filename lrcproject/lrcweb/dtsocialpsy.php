    ...
    <div class="container">
        ...
        <div class="categories">
            ...
            <div class="form-group">
                <span id="title" name="title">Social Psychology</span>
                    <input type="hidden" name="title" value="Social Psychology"> 
        </div>
            <h3>Duration</h3>
            <div class="social">
                <a href="#" onclick="showSection ('pic')"> </a>
                <img src="../images/socialpsy.jpg">
        </div>  
