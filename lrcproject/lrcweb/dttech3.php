    ...
    <header class="header">
        <div class="logo">
            <img src="../images/msc.png" width="50px" height="70px">
             ...
             <a href= " ../lrcweb/technology.php">«</a>
        </div>
             <div class="bell">
    ...
    <div class="container">
        ...
        <div class="categories">
            ...
            <div class="form-group">
                <span id="title" name="title">Foundry Technology</span>
                    <input type="hidden" name="title" value="Foundry Technology"> 
        </div>
            <h3>Duration</h3>
            <div class="social">
