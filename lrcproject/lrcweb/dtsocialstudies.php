    ...
    <div class="container">
        ...
        <div class="categories">
            ...
            <div class="form-group">
                <span id="title" name="title">Social Studies</span>
                    <input type="hidden" name="title" value="Social Studies"> 
        </div>
            <h3>Duration</h3>
            <div class="social">
                <a href="#" onclick="showSection ('pic')"> </a>
                <img src="../images/socialstudies.jpg">
        </div>  
     ...
     <a href=" ../lrcweb/rsocialstudies.php">
