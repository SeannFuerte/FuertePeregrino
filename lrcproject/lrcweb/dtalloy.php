    ...
    <div class="container">
        ...
        <div class="categories">
            ...
            <div class="form-group">
                <span id="title" name="title">The Alloy of Law</span>
                    <input type="hidden" name="title" value="The Alloy of Law"> 
        </div>
            <h3>Duration</h3>
            <div class="social">
                <a href="#" onclick="showSection ('pic')"> </a>
                <img src="../images/alloy.jpg">
        </div>  
