    ...
    <div class="container">
        ...
        <div class="categories">
            ...
            <div class="form-group">
                <span id="title" name="title">Comprehensive Health</span>
                    <input type="hidden" name="title" value="Comprehensive Health"> 
        </div>
            <h3>Duration</h3>
            <div class="social">
                <a href="#" onclick="showSection ('pic')"> </a>
                <img src="../images/comprehensivehealth.jpg">
        </div>  
     ...
     <a href=" ../lrcweb/rcomprehensivehealth.php">
