    ...
    <div class="container">
        ...
        <div class="categories">
            ...
            <div class="form-group">
                <span id="title" name="title">Understanding Mental Illness</span>
                    <input type="hidden" name="title" value="Understanding Mental Illness"> 
        </div>
            <h3>Duration</h3>
            <div class="social">
     ...
     <a href=" ../lrcweb/rmentalhealth.php">
